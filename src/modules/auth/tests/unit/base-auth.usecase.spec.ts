...
import { IUser, User } from '@modules/accounts/domain/entities/user.entity';
...
import { AuthenticatedUser, BaseAuthUseCase } from '@modules/auth/application/base/base-auth.usecase';
