...
import { StatusDto } from '@shared/dtos/common.dto';
...
export const RefreshSessionRequestDto = t.Object(
  {
...
export type RefreshSessionRequestDtoType = typeof RefreshSessionRequestDto;
